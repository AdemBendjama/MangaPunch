...
function CardLargeLoading() {
  return (
    <div className="flex flex-col gap-[0.5rem] lg:w-[176px] sm:w-[18vw] w-[28vw] animate-pulse">
      ...
      <span className="bg-gray-200 font-semibold sm:text-sm text-xs sm:min-h-[2.5rem] min-h-[2rem] text-muted-foreground w-full overflow-hidden text-ellipsis line-clamp-2" />
    </div>
  );
}
