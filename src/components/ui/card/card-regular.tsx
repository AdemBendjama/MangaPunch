...
function CardSmall() {
  return (
    <div className="flex flex-col gap-[0.5rem] 3xl:w-[9vw] xl:w-[13vw] lg:w-[12.5vw] md:w-[16vw] xs:w-[20vw] w-[29vw]">
      <div className="3xl:h-[14.5vw] lg:h-[20vw] md:h-[26vw] xs:h-[31vw] h-[46.5vw] rounded-[6px] overflow-hidden relative">
        <Image
